...
import ShowModal from './Common/ShowMessage/ShowModal';
                    ...
                    <div className='card-body'>
                      <form>
                        ...
                        <input
                          ...
                          className='col-xl-4 col-lg-4 d-none d-xl-block d-lg-block justify-content-md-center btn btn-block  btn-success'
                          value='ارسال'
                          disabled={showLoader}
                          onClick={(e) => {
                            validateAndSend(e);
